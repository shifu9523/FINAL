...
# -------------------------
    ...
    # API KEY
    # =========================
    st.text ("API KEY: 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")
